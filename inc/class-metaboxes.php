...
class DMHStaff_Metaboxes {
	...
	public function add_metaboxes() {
		...
		add_meta_box(
			'metabox_name',
			apply_filters( $this->theme_name . '-metabox-name-title', esc_html__( 'Metabox Name', 'dmhstaff' ) ),
			array( $this, 'metabox' ),
			'posttypename',
			'normal',
			'default',
	...
	public function change_featured_image_labels( $labels ) {
		...
		$labels->featured_image 		= esc_html__( 'Featured Image', 'dmhstaff' );
		$labels->set_featured_image 	= esc_html__( 'Set featured image', 'dmhstaff' );
		$labels->remove_featured_image 	= esc_html__( 'Remove featured image', 'dmhstaff' );
		$labels->use_featured_image 	= esc_html__( 'Use as featured image', 'dmhstaff' );
	...
	private function get_metabox_fields() {
		...
		$fields[] 	= array( 'fieldID', 'text', 'Field Name' );
