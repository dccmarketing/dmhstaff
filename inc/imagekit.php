 ...
 */
function dmhstaff_get_customizer_image_info( $name ) {
	...
	$id = dmhstaff_get_image_id( $image_url );
...
} // dmhstaff_get_customizer_image_info()
 ...
 */
function dmhstaff_get_featured_images( $postID ) {
 ...
 */
function dmhstaff_get_image_id( $image_url ) {
 ...
 */
function dmhstaff_get_svg( $svg ) {

	if ( empty( $svg ) ) { return; }

	$list = dmhstaff_get_svg_list();
 ...
 */
function dmhstaff_get_svg_list() {
	...
	/**
	 * The dmhstaff_svgs filter
	 */
	$list = apply_filters( 'dmhstaff_svgs', $list );

	return $list;

} // dmhstaff_get_svg_list()
 ...
 */
function dmhstaff_get_thumbnail_url( $postID, $size = 'thumbnail' ) {
 ...
 */
function dmhstaff_get_video_thumb( $embed_code ) {
 ...
 * @return 	mixed 					The SVG code
 */
function dmhstaff_the_svg( $svg ) {

	echo dmhstaff_get_svg( $svg );
