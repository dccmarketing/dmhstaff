 ...
 * @package 	TCCi
 */
class DMHStaff_Post_Format_Metaboxes {
	...
	public function add_metaboxes() {
		...
		add_meta_box(
			'post_format_link',
			apply_filters( $this->theme_name . '-post-format-link-title', esc_html__( 'Post Link', 'dmhstaff' ) ),
			array( $this, 'metabox' ),
			'post',
			'top',
			'high',
		...
		add_meta_box(
			'post_format_video',
			apply_filters( $this->theme_name . '-post-format-video-title', esc_html__( 'Post Video', 'dmhstaff' ) ),
			array( $this, 'metabox' ),
			'post',
			'top',
			'high',
		...
		add_meta_box(
			'post_format_image',
			apply_filters( $this->theme_name . '-post-format-image-title', esc_html__( 'Post Image', 'dmhstaff' ) ),
			array( $this, 'metabox' ),
			'post',
			'top',
			'high',
