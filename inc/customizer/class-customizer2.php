...
class DMHStaff_Customizer {
	...
	public function control_scripts() {
		...
		wp_enqueue_script( 'dmhstaff_customizer_controls', get_stylesheet_directory_uri() . '/js/customizer-controls.min.js', array( 'jquery', 'customize-controls' ), false, true );
	...
	public function live_preview() {
		...
		wp_enqueue_script( 'dmhstaff_customizer', get_stylesheet_directory_uri() . '/js/customizer.min.js', array( 'jquery', 'customize-preview' ), '', true );
